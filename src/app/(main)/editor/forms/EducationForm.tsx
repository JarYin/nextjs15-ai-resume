...
import { educationSchema, EducationsValues } from "@/lib/validation";
...
export default function EducationForm({
  ...
  const form = useForm<EducationsValues>({
    ...
    <div className="max-w-xl mx-auto space-y-6">
      <div className="space-y-1.5 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          Add as many work educations as you want.
        </p>
      </div>
      <Form {...form}>
...
interface EducationItemProps {
  id: string;
  form: UseFormReturn<EducationsValues>;
  index: number;
