...
import resumePreviewCreative1 from "@/assets/resume-preview-creative-1.png";
...
export const templates = [
  ...
  //   { id: "pro-2", name: "Executive", category: "professional", color: "bg-stone-100" },
    { id: "creative-1", name: "Bold Peach", category: "creative", color: "bg-orange-100", img: resumePreviewCreative1 },
